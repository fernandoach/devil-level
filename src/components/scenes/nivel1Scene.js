...
class Nivel1Scene extends Phaser.Scene {
  constructor() {
    ...
    this.score = 0;
    this.handleDeath = () => {
        this.deathCount += 1; // Aumenta el contador de muertes
  ...
  create() {
    ...
    this.deathText = this.add.text(10, 10, `MUERTES: ${this.deathCount}`, { fontSize: '16px', fill: '#f11' });
    
    this.scoreText = this.add.text(600, 10, `PUNTAJE: ${this.score}`, { fontSize: '16px', fill: '#0B7' });
